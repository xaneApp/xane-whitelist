        ...
        <div className="relative z-20 w-full pt-4 text-left sm:pt-6 lg:w-[55%] lg:pr-8 lg:pt-0">
          ...
          >
            <motion.button
              ...
              className="rounded-2xl bg-[#D9FF3F] px-8 py-3.5 sm:px-10 sm:py-4 text-base sm:text-lg font-bold text-[#111111] shadow-lg transition-all hover:bg-[#cbf530] active:scale-95 cursor-pointer"
            >
              Join waitlist
            </motion.button>
          </motion.div>
